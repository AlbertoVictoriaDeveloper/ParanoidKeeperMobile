...
(function(c) {
    ...
    ):"object"===typeof exports?module.exports=function(l,
    k) {
        l||(l=window);
...
p) {
    var m=c.fn.dataTable, j=function(a, b) {
        ...
        this.s= {
            dt: new m.Api(a), columns: [], current: []
        }
        ;
...
c(l).width();
            ...
            this.c.breakpoints.sort(function(a,
            b) {
...
b.table().container().offsetWidth-e-n;
            ...
            for(f=d.length;
            e<f;
            e++)if(!d[e].control&&!d[e].never&&!h[e]) {
                g=!0;
                break
            }
            e=0;
...
d.columns().eq(0).map(function(a) {
            ...
            g) {
                if(i)if("max-"===i) {
                    ...
                    if("not-"===i) {
                        ...
                        for(i=b.length;
                        d<i;
                        d++)-1===b[d].name.indexOf(g)&&f(c, b[d].name)
                    }
                }
            ...
            e.each(function(a,
            e) {
                for(var d=a.className.split(" "), f=!1, j=0, l=d.length;
                j<l;
                j++) {
                    var k=c.trim(d[j]);
                    if("all"===k) {
...
d.type&&(d.target="td:first-child, th:first-child");
            ...
            var e=d.target;
            c(b.table().body()).on("click.dtr mousedown.dtr mouseup.dtr",
...
g)return
                    ...
                    false):d.type==="mousedown"?c(this).css("outline",
                    "none"):d.type==="mouseup"&&c(this).blur().css("outline",
                    "")
                }
            }
            )
        ...
        ,
        _find:function(a) {
            for(var b=this.c.breakpoints, d=0, c=b.length;
            d<c;
            d++)if(b[d].name===a)return b[d]
        }
        ,
        ...
        _resize:function() {
            ...
            for(d=g.length;
            h<d;
            h++)if(!1===i[h]&&!g[h].never&& !g[h].control) {
                e=!0;
                break
            }
    ...
    o.register("responsive()",
    function() {
        return this
    }
    );
    o.register("responsive.index()",
    function(a) {
        a=c(a);
        return {
            column: a.data("dtr-index"), row: a.parent().data("dtr-index")
        }
    }
    );
    o.register("responsive.rebuild()",
    function() {
    ...
    o.register("responsive.hasHidden()",
    function() {
